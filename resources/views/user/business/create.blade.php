            ...
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-md-4 mb-3">
                        ...
                        <select name="business_type" class="form-select @error('business_type') is-invalid @enderror" required>
                            ...
                            <option value="kerajinan" {{ old('business_type') == 'kerajinan' ? 'selected' : '' }}>Kerajinan (Handmade)</option>
                            <option value="pertanian" {{ old('business_type') == 'pertanian' ? 'selected' : '' }}>Pertanian (Sayur, Buah, dll)</option>
                            <option value="perikanan" {{ old('business_type') == 'perikanan' ? 'selected' : '' }}>Perikanan (Ikan & Hasil Laut)</option>
                            <option value="jasa" {{ old('business_type') == 'jasa' ? 'selected' : '' }}>Jasa (Layanan)</option>
                            <option value="perdagangan" {{ old('business_type') == 'perdagangan' ? 'selected' : '' }}>Perdagangan (Toko/Retail)</option>
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <select name="business_scale" class="form-select @error('business_scale') is-invalid @enderror" required>
                            <option value="mikro" {{ old('business_scale') == 'mikro' ? 'selected' : '' }}>Mikro (Aset &lt; 50 Juta)</option>
                            <option value="kecil" {{ old('business_scale') == 'kecil' ? 'selected' : '' }}>Kecil (Aset 50 Juta - 500 Juta)</option>
                            <option value="menengah" {{ old('business_scale') == 'menengah' ? 'selected' : '' }}>Menengah (Aset &gt; 500 Juta)</option>
                        </select>
                ...
                <div class="mb-3">
                    ...
                    <textarea name="description" rows="4" class="form-control @error('description') is-invalid @enderror" required
                              placeholder="Ceritakan tentang usaha Anda, produk/layanan yang ditawarkan, keunggulan, dan hal menarik lainnya...">{{ old('description') }}</textarea>
                ...
                <div class="row">
                    ...
                    <div class="col-md-3 mb-3">
                        ...
                        <input type="number" name="employee_count" class="form-control @error('employee_count') is-invalid @enderror" 
                               value="{{ old('employee_count', 1) }}" min="1"
                               placeholder="1">
                    ...
                    <div class="col-md-3 mb-3">
                        ...
                        <input type="number" name="monthly_revenue" class="form-control @error('monthly_revenue') is-invalid @enderror" 
                               value="{{ old('monthly_revenue') }}" min="0"
                               placeholder="5000000">
        ...
        <div class="form-card">
            ...
            <div class="card-body">
                <div class="mb-3">
                    ...
                    <textarea name="address" rows="2" class="form-control @error('address') is-invalid @enderror" required
                              placeholder="Contoh: Jl. Merdeka No. 123, RT 001/RW 002, Dekat Pasar Kisaran">{{ old('address') }}</textarea>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="text" name="postal_code" class="form-control @error('postal_code') is-invalid @enderror" 
                               value="{{ old('postal_code') }}" maxlength="5"
                               placeholder="21224">
                ...
                <div class="map-instruction">
                    ...
                    <div>
                        ...
                        <br>2️⃣ Atau klik langsung pada peta satelit untuk menandai lokasi usaha secara manual
                        <br>3️⃣ Zoom in/out untuk melihat lokasi dengan lebih detail
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" name="latitude" id="latitude" class="form-control coord-display @error('latitude') is-invalid @enderror" 
                               value="{{ old('latitude') }}" required readonly placeholder="Akan terisi otomatis setelah Anda klik peta">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" name="longitude" id="longitude" class="form-control coord-display @error('longitude') is-invalid @enderror" 
                               value="{{ old('longitude') }}" required readonly placeholder="Akan terisi otomatis setelah Anda klik peta">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" name="pirt" class="form-control @error('pirt') is-invalid @enderror" 
                               value="{{ old('pirt') }}" placeholder="Contoh: 1234567890">
                ...
                <div class="row">
                    <div class="col-md-12 mb-3">
                        ...
                        <input type="text" name="halal_certificate" class="form-control @error('halal_certificate') is-invalid @enderror" 
                               value="{{ old('halal_certificate') }}" placeholder="Contoh: 00000000000000000000">
                ...
                <div class="row">
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="text" name="instagram" class="form-control @error('instagram') is-invalid @enderror" 
                               value="{{ old('instagram') }}" placeholder="@usaha_saya">
...
<script>
    ...
    const mapCenter = [{{ env('MAP_CENTER_LAT', 2.9833) }}, {{ env('MAP_CENTER_LNG', 99.6167) }}];
    const map = L.map('map', {
        center: mapCenter,
        zoom: 13,
        zoomControl: true,
    ...
    @if(old('latitude') && old('longitude'))
        marker = L.marker([{{ old('latitude') }}, {{ old('longitude') }}], { icon: userIcon }).addTo(map);
