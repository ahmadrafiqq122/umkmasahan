<?php $__env->startSection('title', 'Dashboard Pelaku Usaha'); ?>
            ...
            <div class="row align-items-center">
                <div class="col-lg-8">
                    <h2 class="fw-bold mb-2">
                        <i class="bi bi-person-circle me-2"></i>Selamat Datang, <?php echo e(auth()->user()->name); ?>!
                    </h2>
...
<div class="container">
    ...
    <div class="stats-grid">
        <div class="stat-card-user">
            ...
            <div class="stat-number" style="color: var(--asahan-green);"><?php echo e($stats['total']); ?></div>
        ...
        <div class="stat-card-user">
            ...
            <div class="stat-number" style="color: #10b981;"><?php echo e($stats['approved']); ?></div>
        ...
        <div class="stat-card-user">
            ...
            <div class="stat-number" style="color: #f59e0b;"><?php echo e($stats['pending']); ?></div>
        ...
        <div class="stat-card-user">
            ...
            <div class="stat-number" style="color: #ef4444;"><?php echo e($stats['rejected']); ?></div>
    ...
    <div class="mb-4">
        <div class="d-flex justify-content-between align-items-center mb-3">
            ...
            <?php if($businesses->count() > 0): ?>
                <a href="<?php echo e(route('user.business.create')); ?>" class="btn btn-asahan-primary">
                    ...
                    <div class="col-lg-6">
                        <div class="business-card">
                            <div class="business-header">
                                <div>
                                    <h5 class="mb-1 fw-bold" style="color: var(--asahan-green);"><?php echo e($business->business_name); ?></h5>
                                    <p class="text-muted mb-0 small"><?php echo e($business->owner_name); ?></p>
                                </div>
                                <span class="status-badge-large bg-<?php echo e($business->status === 'approved' ? 'success' : ($business->status === 'pending' ? 'warning' : 'danger')); ?>">
                            ...
                            <div class="business-body">
                                <div class="info-row">
                                    ...
                                    <span><?php echo e($business->getBusinessTypeLabel()); ?></span>
                                </div>
                                <div class="info-row">
                                    <i class="bi bi-geo-alt-fill"></i>
                                    <span><?php echo e($business->district); ?></span>
                                </div>
                                <div class="info-row">
                                ...
                                <div class="info-row">
                                    ...
                                    <span><?php echo e($business->photos_count); ?> Foto</span>
                                </div>
                                <?php if($business->status === 'rejected' && $business->rejection_reason): ?>
                                    <div class="alert alert-danger mt-3 mb-0">
                                        <small><strong>Alasan Penolakan:</strong><br><?php echo e($business->rejection_reason); ?></small>
                                    </div>
                                <?php endif; ?>
                            </div>
                            ...
                            <div class="business-footer">
                                <small class="text-muted">
                                    <i class="bi bi-calendar me-1"></i><?php echo e($business->created_at->format('d M Y')); ?>

                                </small>
                                <div class="btn-group">
                                    <a href="<?php echo e(route('user.business.show', $business->id)); ?>" 
                                       class="btn btn-sm btn-outline-primary"
                                       title="Lihat Detail">
                                        <i class="bi bi-eye"></i>
                                    </a>
                                    <a href="<?php echo e(route('user.business.edit', $business->id)); ?>" 
                                    ...
                                    <button type="button" 
                                            ...
                                            onclick="deleteConfirm(<?php echo e($business->id); ?>)"
                                            title="Hapus">
        ...
        <?php else: ?>
            <div class="empty-state">
                ...
                <a href="<?php echo e(route('user.business.create')); ?>" class="btn btn-asahan-primary btn-lg">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/umkm/resources/views/user/dashboard.blade.php ENDPATH**/ ?>