                ...
                <div class="row g-0 auth-card">
                    ...
                    <div class="col-md-5 d-none d-md-block">
                        <div class="auth-brand">
                            <div class="auth-brand-content">
                                <div class="logo-box">
                                    <?php if(file_exists(public_path('images/logo-asahan.png'))): ?>
                                        <img src="<?php echo e(asset('images/logo-asahan.png')); ?>" alt="Logo" style="max-width: 80px; max-height: 80px;">
                                    <?php else: ?>
                            ...
                            <p class="mb-0 opacity-75" style="font-size: 0.85rem; position: relative; z-index: 1;">
                                © <?php echo e(date('Y')); ?> Disperindagkop Kab. Asahan
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="col-md-7">
                        <div class="auth-form">
                            ...
                            <form method="POST" action="<?php echo e(route('login')); ?>" class="form-asahan">
                                <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="text-center">
                                    <p class="text-muted mb-2">
                                        Belum punya akun? 
                                        <a href="<?php echo e(route('register')); ?>" style="color: var(--asahan-green); font-weight: 600;">
                                            Daftar Sekarang
                                        </a>
                                    </p>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/umkm/resources/views/auth/login.blade.php ENDPATH**/ ?>