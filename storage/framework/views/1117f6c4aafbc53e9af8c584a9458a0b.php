                        ...
                        <div class="auth-content">
                            <div class="verification-header">
                                ...
                                <div class="email-display text-center">
                                    ...
                                    <strong style="color: var(--asahan-green); font-size: 1.05rem;"><?php echo e($email ?? session('verification_email')); ?></strong>
                                </div>
                            </div>
                            ...
                            <form method="POST" action="<?php echo e(route('verification.verify')); ?>" id="verificationForm">
                                <?php echo csrf_field(); ?>
                                <input type="hidden" name="email" value="<?php echo e($email ?? session('verification_email')); ?>">
    ...
    resendBtn.click(function() {
        ...
        $.ajax({
            ...
            data: {
                ...
                email: '<?php echo e($email ?? session("verification_email")); ?>'
            },
